...
ret <- parLapplyLB(cl = cl,
                   ...
                   fun = function(a){
                     ...
                     parameter.values.smooth <- list("CCIDCI"=parameter.values.smooth.ccidci)
                     ...
                     print("CCIDCI men")
                     print(Sys.time())
                     modelname <- paste0(a,"_","CCIDCI",
                                         "",
                                         maxfu,
                                         "",
                                         "man")
                     loads <- load(file=paste0("C:\\Marcus\\LEcox\\LE_model_",modelname,".Rdata"))
                     temp <-  parameter.values.smooth[[ "CCIDCI" ]][["man"]]
                     ...
                     modelname <- paste0(a,"_","CCIDCI",
                                         ...
                                         "woman")
                     loads <- load(file=paste0("C:\\Marcus\\LEcox\\LE_model_",modelname,".Rdata"))
                     temp <-  parameter.values.smooth[[ "CCIDCI" ]][["woman"]]
                     ...
                     data.m$le.ccidci <- unlist(le.men)
                     ...
                     data.f$le.ccidci <- unlist(le.women)
                     ...
                     print("Saving")
                     print(Sys.time())
                     save(LE,file=paste0("C:\\Marcus\\LEcox\\LE_age_ccidci",a,".Rdata"))
