...
ret <- parLapply(cl = cl,
                 ...
                 fun = function(cluster_id){
                   ...
                   data <- data %>%
                     select(LopNr,indexdate,rowid,indexyear,sex,indexage,comorbidity_index_MDCI_sv)
                   gc()
...
n_mdci_sv
save(n_mdci_sv,file=paste0(save_path,"n_mdci_sv.Rdata"))
