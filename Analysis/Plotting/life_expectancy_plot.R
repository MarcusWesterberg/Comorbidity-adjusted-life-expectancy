                   ...
                   fun = function(a){
                     ...
                     ret_overall <- LE %>%
                       summarise(n=n(),
                                 ...
                                 le_cci_min=min(le.cci),
                                 le_cci_05=quantile(le.cci,probs=0.05),
                                 le_cci_25=quantile(le.cci,probs=0.25),
                                 le_cci_50=quantile(le.cci,probs=0.5),
                                 le_cci_75=quantile(le.cci,probs=0.75),
                                 le_cci_95=quantile(le.cci,probs=0.95),
                                 le_cci_max=max(le.cci),
                                 le_cci_mean=mean(le.cci),
                                 
                                 le_crude_min=min(le.crude),
                                 le_crude_05=quantile(le.crude,probs=0.05),
                                 le_crude_25=quantile(le.crude,probs=0.25),
                                 le_crude_50=quantile(le.crude,probs=0.5),
                                 le_crude_75=quantile(le.crude,probs=0.75),
                                 le_crude_95=quantile(le.crude,probs=0.95),
                                 le_crude_max=max(le.crude),
                                 le_crude_mean=mean(le.crude),
                     ...
                     ret_overall_d <- LE %>%
                       mutate(le=le-le_scb,
                              le.cci=le.cci-le_scb,
                              le.crude=le.crude-le_scb) %>%
                       summarise(n=n(),
                                 le_min=min(le),
                                 le_05=quantile(le,probs=0.05),
                                 le_25=quantile(le,probs=0.25),
...
stopCluster(cl)
gc(verbose = FALSE)
save(ret,file="X:\\ComorbidityBase\\Works\\2024\\2024 Assessment of comorbidity indices\\Results\\life_expectancy_dist.Rdata")


load(file="X:\\ComorbidityBase\\Works\\2024\\2024 Assessment of comorbidity indices\\Results\\life_expectancy_dist.Rdata")
...
svg("X:\\ComorbidityBase\\Works\\2024\\2024 Assessment of comorbidity indices\\Results\\life_expectancy_cci.svg",width=10,height=4)
...
polygon(x=c(temp$age,rev(temp$age)),
        y=c(temp$le_cci_05,rev(temp$le_cci_95)),
        border=NA,
        col=rgb(0,0,0,0.1))
lines(temp$age,temp$le_cci_05,lty=3,lwd=3,col="darkgrey")
lines(temp$age,temp$le_cci_95,lty=3,lwd=3,col="darkgrey")

mtext(side=1,text="Age (years)",line=2)
mtext(side=2,text="LE comorbidity - LE life table (years)",line=2)
...
###
# MDCI and DCI
svg("X:\\ComorbidityBase\\Works\\2024\\2024 Assessment of comorbidity indices\\Results\\life_expectancy_mdcidci.svg",width=10,height=4)
par(mfrow=c(1,2),mar=c(3,3,4,1))
...
###
# MDCI and DCI
svg("X:\\ComorbidityBase\\Works\\2024\\2024 Assessment of comorbidity indices\\Results\\life_expectancy_mdcidci_overall.svg",width=6,height=5)
par(mfrow=c(1,2),mar=c(3,3,4,1))
...
svg("X:\\ComorbidityBase\\Works\\2024\\2024 Assessment of comorbidity indices\\Results\\life_expectancy_cci_alt.svg",width=10,height=4)
par(mfrow=c(1,2),mar=c(3,3,4,1))
...
###
# MDCI and DCI
svg("X:\\ComorbidityBase\\Works\\2024\\2024 Assessment of comorbidity indices\\Results\\life_expectancy_mdcidci_alt.svg",width=10,height=4)
par(mfrow=c(1,2),mar=c(3,3,4,1))
...
###
# MDCI and DCI
svg("X:\\ComorbidityBase\\Works\\2024\\2024 Assessment of comorbidity indices\\Results\\life_expectancy_mdcidci_alt2.svg",width=6,height=5)
par(mfrow=c(1,2),mar=c(3,3,4,1))
...
###
# MDCI and DCI
svg("X:\\ComorbidityBase\\Works\\2024\\2024 Assessment of comorbidity indices\\Results\\life_expectancy_mdcidci_overall_alt.svg",width=10,height=4)
par(mfrow=c(1,2),mar=c(3,3,4,1))
...
view(ret_cci %>%
       select(sex,age,CCI,n) %>%
       group_by(sex,age) %>%
       mutate(p=n/sum(n)*100) %>%
       ungroup() %>%
       pivot_wider(names_from = CCI, values_from = c(n,p)) %>%
       arrange(sex,age))
...
require(tidyr)
cci_table <- ret_cci %>%
  select(sex,age,CCI,le_cci_mean) %>% 
  pivot_wider(names_from = CCI, values_from = c(le_cci_mean)) %>%
  arrange(sex,age)
colnames(cci_table)[-c(1:2)]<-paste0("CCI_",0:6)

for(k in 3:9){
  cci_table[[k]]<- format(round(cci_table[[k]],dig=1),nsmall=1)
}

openxlsx::write.xlsx(cci_table,file=paste0(figs_path,"cci_le_table.xlsx"))
